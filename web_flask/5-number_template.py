...
def number_template(n):
    ...
    /templates/ est le répertoire par défaut pour les templates
    pour modifier le répertoire par défaut, il faut ajouter
    app = Flask(__name__, template_folder='autre_repertoire_templates')"""
